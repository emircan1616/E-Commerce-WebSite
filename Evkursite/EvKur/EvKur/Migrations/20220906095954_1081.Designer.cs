...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EvKur.Models.Entity.Class", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EvKur.Models.Shop.Sepet", b =>
                {
                    ...
                    b.HasIndex("bayiProductId")
                        .IsUnique()
                        .HasFilter("[bayiProductId] IS NOT NULL");
            ...
            modelBuilder.Entity("EvKur.Models.Shop.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EvKur.Models.Shop.Sepet", b =>
                {
                    ...
                    b.HasOne("EvKur.Models.Shop.ShoppingCart", null)
                        .WithMany("Items")
                        .HasForeignKey("ShoppingCartId");

                    b.HasOne("EvKur.Models.Shop.BayiProduct", "bayiProduct")
                        .WithOne("sepet")
                        .HasForeignKey("EvKur.Models.Shop.Sepet", "bayiProductId");

                    b.HasOne("EvKur.Models.User.Customer", "customer")
                        .WithMany()
